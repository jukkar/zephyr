 ...
 * added.
 */
static NET_BMEM uint32_t stale_counter;
...
#if defined(CONFIG_NET_IPV6_NBR_CACHE)
static NET_DMEM struct net_icmpv6_handler ns_input_handler = {
	.type = NET_ICMPV6_NS,
	.code = 0,
	.handler = handle_ns_input,
};

static NET_DMEM struct net_icmpv6_handler na_input_handler = {
	.type = NET_ICMPV6_NA,
	.code = 0,
...
#if defined(CONFIG_NET_IPV6_ND)
static NET_DMEM struct net_icmpv6_handler ra_input_handler = {
	.type = NET_ICMPV6_RA,
	.code = 0,
...
#if defined(CONFIG_NET_IPV6_NBR_CACHE) || defined(CONFIG_NET_IPV6_ND)
	k_thread_access_grant(thread, &nbr_lock);
#endif
