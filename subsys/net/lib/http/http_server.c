...
#define HTTP_SERVER_MAX_RESPONSE_SIZE CONFIG_HTTP_SERVER_MAX_RESPONSE_SIZE
...
static char url_buffer[CONFIG_HTTP_SERVER_MAX_URL_LENGTH];
static char http_response[CONFIG_HTTP_SERVER_MAX_RESPONSE_SIZE];
