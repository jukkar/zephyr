...
/* Service events */
#define _NET_SERVICE_LAYER	NET_MGMT_LAYER_L3
#define _NET_SERVICE_CORE_CODE	0x800
#define _NET_EVENT_SERVICE_BASE	(NET_MGMT_EVENT_BIT |			\
				 NET_MGMT_IFACE_BIT |			\
				 NET_MGMT_LAYER(_NET_SERVICE_LAYER) |	\
				 NET_MGMT_LAYER_CODE(_NET_SERVICE_CORE_CODE))

enum net_event_service_cmd {
	NET_EVENT_SERVICE_CMD_IDLE = 0,
	NET_EVENT_SERVICE_CMD_CONNECTING,
	NET_EVENT_SERVICE_CMD_CONNECTED,
	NET_EVENT_SERVICE_CMD_DISCONNECTING,
};

#define NET_EVENT_SERVICE_IDLE					\
	(_NET_EVENT_SERVICE_BASE | NET_EVENT_SERVICE_CMD_IDLE)

#define NET_EVENT_SERVICE_CONNECTING				\
	(_NET_EVENT_SERVICE_BASE | NET_EVENT_SERVICE_CMD_CONNECTING)

#define NET_EVENT_SERVICE_CONNECTED				\
	(_NET_EVENT_SERVICE_BASE | NET_EVENT_SERVICE_CMD_CONNECTED)

#define NET_EVENT_SERVICE_DISCONNECTING				\
	(_NET_EVENT_SERVICE_BASE | NET_EVENT_SERVICE_CMD_DISCONNECTING)
